...
class BuyHouseController extends Controller
{
    ...
    public function checkDays(Request $request)
    {
        ...
        foreach ($period as $date) {
            ...
            // f. Thêm tất cả kết quả vào mảng `days` của năm âm tương ứng
...
Thời điểm cát lợi, vận khí hanh thông – rất thích hợp để an cư, lập nghiệp";
    ...
    public function showDayDetails(Request $request, $date)
    {
        ...
        $groomData = BadDayHelper::getDetailedAnalysisForPerson($dateToCheck, $groomDob, 'Ngày mua nhà', 'MUA_NHA_DAT');
