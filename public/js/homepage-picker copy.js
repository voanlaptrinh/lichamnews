...
class HomepagePicker extends BasePicker {
    ...
    async updatePageContent(year, month, day) {
        ...
        try {
            ...
            if (data.success) {
                ...
                // KHÔNG cập nhật URL - giữ nguyên trang chủ
    ...
    setupQuickPicker() {
        ...
        // View button click - CHỈ cập nhật nội dung, KHÔNG thay đổi URL
        viewDateBtn.addEventListener('click', async () => {
            ...
            // Cập nhật nội dung qua AJAX, KHÔNG thay đổi URL
    ...
    async generatePopupCalendar(month, year, highlightDay = null) {
        ...
        for (let day = 1; day <= daysInMonth; day++) {
            ...
            // Click handler for day selection - CHỈ cập nhật nội dung
            dayElement.addEventListener('click', async () => {
                ...
                // Close popup and update content
                const quickPickerOverlay = document.getElementById('quickPickerOverlay');
                this.closePopup(quickPickerOverlay);
