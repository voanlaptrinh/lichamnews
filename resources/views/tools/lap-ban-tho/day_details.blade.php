...
@section('content')
    ...
    <div class="container-setup">
        ...
        <h1 class="content-title-home-lich">Chi tiết xem ngày lập bàn thờ
                            ...
                            <div>
                                <table class="table table-detail" style="table-layout: fixed;">
                                    <tbody>
                                        ...
                                        @php
                                            $weights =
                                                \App\Helpers\DataHelper::$PURPOSE_WEIGHTS_PERSONALIZED['LAP_BAN_THO'];
...
@push('scripts')
    <script>
        function goBackToForm() {
            ...
            let targetUrl = '{{ route('lap-ban-tho.form') }}';
            const hashParams = [];
