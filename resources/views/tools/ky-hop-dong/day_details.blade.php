...
@section('content')
    ...
    <div class="container-setup">
        ...
        <h1 class="content-title-home-lich">Chi tiết xem ngày ký hợp đồng
                ...
                <div class="col-xl-9 col-sm-12 col-12 ">
                    ...
                    <div class="card border-0 mb-3 w-100 box-detial-year">
                        <div class="card-body box1-con-year">
                            <div
                                class="text-primary mb-3 title-tong-quan-h4-log text-dark d-flex align-items-center fw-bolder">
                                <img src="{{ asset('icons/dac-diem1.svg') }}" alt="thông tin người ký hợp đồng"
                                    width="28" height="28" class="me-1"> <span>Đánh giá điểm chỉ số ngày tốt cho
                                    tuổi
                            ...
                            <div
                                ...
                                <div>
                                    <img src="{{ asset('icons/dac-diem1.svg') }}"
                                        alt="Luận giải các yếu tố tốt xấu trong ngày" width="28" height="28"
                                        class="me-1">
                                </div>
                                            ...
                                            <div id="collapse-thap-nhi-truc-{{ Str::slug($groomData['personTitle']) }}"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <p class="mb-1"><b>Trực ngày: </b>Trực
                                                        ...
                                                        trực
                                                        {{ $getThongTinTruc['description']['rating'] }} cho việc ký kết hợp
                                                        đồng.
                                                    </p>
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapse-sao-cat-hung-{{ Str::slug($groomData['personTitle']) }}"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <h6><i class="fas fa-star text-success"></i> Sao tốt cho việc ký
                                                        hợp đồng:</h6>
