...
@section('content')
    ...
    <div class="container-setup">
        ...
        <h1 class="content-title-home-lich">Chi tiết xem ngày ký hợp đồng</h1>
                            ...
                            <div class="box-title-goback">
                                <div
                                    ...
                                    <img src="{{ asset('icons/dac-diem1.svg') }}" alt="thông tin người ký hợp đồng" width="28"
                                        height="28" class="me-1"> <span>Thông Tin Ngày Ký Hợp Đồng</span>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td style="font-weight: 600">
                                                Các yếu tố tốt hỗ trợ cho việc ký hợp đồng
                                            </td>
                                            <td style="font-weight: 600">
                                        ...
                                        <tr>
                                            <td>
                                                @if ($groomData['score']['tu']['details']['data']['nature'] == 'Tốt')
                                                    Nhị thập bát tú: Sao
                                                    {{ $groomData['score']['tu']['details']['data']['name'] }} (Tốt cho việc ký hợp đồng)
                                                @endif
                                            </td>
                                            <td>
                                                @if ($groomData['score']['tu']['details']['data']['nature'] == 'Xấu')
                                                    Nhị thập bát tú: Sao
                                                    {{ $groomData['score']['tu']['details']['data']['name'] }} (Xấu cho việc ký hợp đồng)
                                                @endif
                                            </td>
                                        </tr>
                        ...
                        <div class="card-body box1-con-year">
                            <div
                                ...
                                <img src="{{ asset('icons/dac-diem1.svg') }}" alt="thông tin người ký hợp đồng" width="28"
                                    ...
                                    ({{ $groomData['personInfo']['dob']->format('d-m-Y') }}) ký hợp đồng:
                            ...
                            <div>
                                <table class="table table-detail" style="table-layout: fixed;">
                                    <tbody>
                                        ...
                                        @php
                                            $weights =
                                                \App\Helpers\DataHelper::$PURPOSE_WEIGHTS_PERSONALIZED['KY_HOP_DONG'];
                                        ...
                                        <div class="accordion-item">
                                            ...
                                            <div id="collapse-canchi-{{ Str::slug($groomData['personTitle']) }}"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <h6><b>* Cục khí - hợp xung cho việc ký hợp đồng</b></h6>
                                                    <ul>
                                            ...
                                            <div id="collapse-nhi-thap-bat-tu-{{ Str::slug($groomData['personTitle']) }}"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <p>Ngày này có sao: <b>{{ $nhiThapBatTu['name'] }}
                                                        ...
                                                        Là
                                                        sao <b>{{ $nhiThapBatTu['nature'] }}</b> cho việc ký hợp đồng.</p>
                                            ...
                                            <div id="collapse-thap-nhi-truc-{{ Str::slug($groomData['personTitle']) }}"
                                                ...
                                                <div class="accordion-body">
                                                    ...
                                                    <p class="mb-1"><b>Trực ngày: </b>Trực
                                                        ...
                                                        trực
                                                        {{ $getThongTinTruc['description']['rating'] }} cho việc ký kết hợp đồng.
                                                    </p>
                                            ...
                                            <div class="accordion-item">
                                                ...
                                                <div id="collapse-sao-cat-hung-{{ Str::slug($groomData['personTitle']) }}"
                                                    ...
                                                    <div class="accordion-body">
                                                        ...
                                                        <h6><i class="fas fa-star text-success"></i> Sao tốt cho việc ký hợp đồng:</h6>
...
@push('scripts')
    <script>
        function goBackToForm() {
            ...
            let targetUrl = '{{ route('ky-hop-dong.form') }}';
            const hashParams = [];
