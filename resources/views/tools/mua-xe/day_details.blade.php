...
@section('content')
    ...
    <div class="container-setup">
        ...
        <h1 class="content-title-home-lich">Chi tiết xem ngày mua xe {{ $commonDayInfo['dateToCheck']->format('d/m/Y') }}
        </h1>
                            ...
                            <div>
                                <table class="table table-detail" style="table-layout: fixed;">
                                    <tbody>
                                        ...
                                        @php
                                            $weights = \App\Helpers\DataHelper::$PURPOSE_WEIGHTS_PERSONALIZED['MUA_XE'];
