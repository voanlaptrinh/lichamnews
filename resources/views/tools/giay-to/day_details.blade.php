...
@section('content')
    ...
    <div class="container-setup">
        ...
        <h1 class="content-title-home-lich">Chi tiết xem ngày làm giấy tờ  {{ $commonDayInfo['dateToCheck']->format('d/m/Y') }}</h1>
                    ...
                    <div class="card border-0 mb-3 w-100 box-detial-year">
                        <div class="card-body box1-con-year">
                            <div
                                ...
                                <img src="{{ asset('icons/dac-diem1.svg') }}" alt="Đánh giá điểm chỉ số ngày tốt"
                                    width="28" height="28" class="me-1"> <span>Đánh giá điểm chỉ số ngày tốt cho
                                    tuổi
                                    {{ $groomData['personInfo']['can_chi_nam'] }}
                                    ({{ $groomData['personInfo']['dob']->format('Y') }})</span>
                            </div>
...
@push('scripts')
    <script>
        function goBackToForm() {
            ...
            let targetUrl = '{{ route('giay-to.form') }}';
            const hashParams = [];
