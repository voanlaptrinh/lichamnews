...
@section('content')
    ...
    <div class="container-setup">
        ...
        <h1 class="content-title-home-lich">Chi tiết xem ngày cưới hỏi {{ $commonDayInfo['dateToCheck']->format('d/m/Y') }}
        </h1>
        <div>
                ...
                <div class="col-xl-9 col-sm-12 col-12 ">
                    ...
                    <div class="tab-content" id="personTabContent">
                        ...
                        <div class="tab-pane fade show active" id="groom-tab-pane" role="tabpanel"
                            ...
                            @php
                                $weights = \App\Helpers\DataHelper::$PURPOSE_WEIGHTS_PERSONALIZED['CUOI_HOI'];
