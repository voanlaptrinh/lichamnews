...
@section('content')
    ...
    <div class="container-setup">
        ...
        <h1 class="content-title-home-lich">Chi tiết xem ngày thi cử - phỏng vấn</h1>
                        ...
                        <div class="card-body box1-con-year">
                            <div
                                ...
                                <img src="{{ asset('icons/dac-diem1.svg') }}" alt="thông tin người xem" width="28"
                                    ...
                                    ({{ $groomData['personInfo']['dob']->format('d-m-Y') }}) thi cử - phỏng vấn:
                            ...
                            <div>
                                <table class="table table-detail" style="table-layout: fixed;">
                                    <tbody>
                                        ...
                                        @php
                                            $weights =
                                                \App\Helpers\DataHelper::$PURPOSE_WEIGHTS_PERSONALIZED['THI_CU'];
