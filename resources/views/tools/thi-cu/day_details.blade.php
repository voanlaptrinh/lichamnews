...
@section('content')
    ...
    <div class="container-setup">
        ...
        <h1 class="content-title-home-lich">Chi tiết xem ngày thi cử - phỏng vấn
                            ...
                            <div>
                                <table class="table table-detail" style="table-layout: fixed;">
                                    <tbody>
                                        ...
                                        @php
                                            $weights = \App\Helpers\DataHelper::$PURPOSE_WEIGHTS_PERSONALIZED['THI_CU'];
...
@push('scripts')
    <script>
        function goBackToForm() {
            ...
            let targetUrl = '{{ route('thi-cu.form') }}';
            const hashParams = [];
