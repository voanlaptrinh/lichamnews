    ...
    <div class="container-setup">
        ...
        <div class="text-box-tong-quan box-cart-index-cung">
            ...
            <div>
                ...
                trở nên quen thuộc và được nhiều người trên thế giới, trong đó có Việt Nam, quan tâm và tìm hiểu. Mỗi cung
                Hoàng đạo tương ứng với một khoảng thời gian trong năm, gắn liền với một biểu tượng riêng, một hành tinh
                chiếu mệnh và một nguyên tố (Lửa, Nước, Đất, Khí). Chính vì vậy, các cung Hoàng đạo được cho là phản ánh
                phần nào tính cách, xu hướng hành động và vận mệnh của mỗi người.

            </div>
            <div class="mt-3">
                <h4 class="title-tong-quan-h4" style="font-weight: unset">12 cung Hoàng đạo và tính cách đặc trưng</h4>
                <ul>
            ...
            <div class="mt-3">
                <h4 class="title-tong-quan-h4" style="font-weight: unset">Xem tử vi 12 cung Hoàng đạo để làm gì?</h4>
                <div>
                    Không chỉ đơn thuần là sự tò mò, tử vi 12 cung Hoàng đạo mang lại cho bạn nhiều góc nhìn hữu ích:
                </div>
                <ul>
                    <li>Nắm bắt vận trình <b>tình duyên, công việc, tài chính, sức khỏe</b> theo từng ngày, từng tuần, từng
                        tháng hoặc cả năm.</li>
                    <li>Biết cách lựa chọn thời điểm thuận lợi để tiến hành những việc quan trọng như khởi sự kinh doanh,
                    ...
                    <li>Hiểu thêm về bạn bè, người thân hoặc đối tác thông qua cung Hoàng đạo của họ, từ đó dễ dàng xây dựng
                        các mối quan hệ bền vững.</li>
                </ul>
            </div>
            <div class="mt-3">
                <h4 class="title-tong-quan-h4" style="font-weight: unset">Ứng dụng của cung Hoàng đạo trong đời sống</h4>
                <div>
                    Trong xã hội hiện đại, nhiều người trẻ sử dụng tử vi 12 cung Hoàng đạo như một công cụ tham khảo để:
                </div>
                <ul>
