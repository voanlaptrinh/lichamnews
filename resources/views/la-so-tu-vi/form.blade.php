                            ...
                            <div class="w-100 " style="max-width: 950px;">
                                <div class=" mt-5 mb-5">
                                    ...
                                    <div class="card-body p-1">
                                        <h1 class="text-center mb-4 title-tong-quan-h1-log fw-bold" style="color: #192E52">
                                            Lập Lá Số Tử
                                            Vi và Luận Giải Vận
                                            Mệnh Miễn Phí</h1>
                                        <p class="text-center" style="margin-bottom: 40px">Tra cứu lá số tử vi trọn đời có
                                            thể giúp bạn
                                            hiểu
                                            về
                                            bản thân bao gồm những điểm
                                            mạnh, điểm yếu. Đồng thời nắm bắt được thời điểm tốt để bắt đầu các sự kiện quan
                                            trọng,
                                            chẳng
                                            hạn
                                        ...
                                        <form id="lasoForm" action="{{ route('laso.submit') }}" method="POST">
                                            ...
                                            <div class="row gx-4 gx-md-4 gx-sm-1">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="ho_ten" class="form-label fw-semibold">Họ và
                                                            Tên</label>
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <select name="dl_zodiac_combined" id="dl_zodiac_combined"
                                                                ...
                                                                <option value="" disabled
                                                                    {{ $selectedOptionValue == '' ? 'selected' : '' }}>Chọn
                                                                    giờ
                                                                    sinh
                                                                </option>
                                                                @foreach ($zodiacTimeRanges as $range)
                                                                    @php
                                                                        ...
                                                                        $optionValue =
                                                                            $range['start_h'] . '_' . $range['start_m']; // Giá trị gửi cho JS
                                            ...
                                            <div class="d-flex justify-content-center">
                                                <button type="submit" class="btn btn-light-settup fw-bold"
                                                    id="submitBtn" style="width: 350px;">
                                                    <span class="btn-text">Tạo lá số</span>
