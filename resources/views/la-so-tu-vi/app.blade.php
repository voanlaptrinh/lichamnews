<div class="app-download-banner backgroud_qr mb-3">
    <div class="banner-content">
        ...
        <!-- Main content with QR and Stats -->
        <div class="banner-main">
            <!-- Left side - QR Code -->
            <div class="banner-qr-section">
                <div class="qr-code-wrapper">
                    <div class="qr-placeholder"></div>
                    <div class="qr-center-icon"><img src="{{ asset('images/logo_phonglichqr.svg') }}" alt="">
                    </div>
                </div>
                <p class="qr-text-mobie">Quét mã QR để tải app</p>
            </div>

            <!-- Middle - Stats and Download Buttons -->
            <div class="banner-stats-section">
                ...
                <div class="download-buttons">
                    <a target="_blank" rel="nofollow"
                        href="https://play.google.com/store/apps/details?id=com.rvn.licham&hl=vi" class="btn-download google-play">
                       <svg width="38" height="38"
                        ...
                        <div class="btn-content">
                            <span class="btn-subtitle">Tải về trên</span>
                            <span class="btn-title">Google Play</span>
                        </div>
                    </a>
                    <a  target="_blank" rel="nofollow"
                        href="https://apps.apple.com/vn/app/l%E1%BB%8Bch-%C3%A2m-l%E1%BB%8Bch-v%E1%BA%A1n-ni%C3%AAn-2025/id6499255314?l=vi" class="btn-download app-store">
                        <svg fill="#ffffff" height="32" width="32" version="1.1" id="Capa_1"
                ...
                <div class="text-qr-move">
                    Quét mã QR để tải app 
                </div>
            </div>

            <!-- Right side - Phone Mockup -->
            {{-- <div class="banner-phone-section">
                                        <div class="phone-mockup-wrapper">
                                            <div class="images_phong">
                                                <img src="{{ asset('images/iphone_16_licham.svg') }}" alt="Phone Mockup" class="phone-image">
                                            </div>
