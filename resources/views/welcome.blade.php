...
<head>
    ...
    <link rel="preload" href="{{ asset('/css/bootstrap.min.css?v=6.0') }}" as="style">
    <link rel="preload" href="{{ asset('/css/style-date.css?v=6.0') }}" as="style">

    <!-- Load critical CSS -->
    <link href="{{ asset('/css/bootstrap.min.css?v=6.0') }}" rel="stylesheet">
    <link href="{{ asset('/css/style-date.css?v=6.0') }}" rel="stylesheet">

    <!-- Defer non-critical CSS -->
    <link rel="preload" href="{{ asset('/css/bootstrap-icons.min.css?v=6.0') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="{{ asset('/css/bootstrap-icons.min.css?v=6.0') }}">
    </noscript>
    <link rel="preload" href="{{ asset('/css/repont.css?v=6.0') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="{{ asset('/css/repont.css?v=6.0') }}">
    </noscript>
...
<body>
    ...
    @if (request()->routeIs('home'))
        ...
        <script src="{{ asset('/js/simple-chart.js?v=6.0') }}" defer></script>
    @endif
