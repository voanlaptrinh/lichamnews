...
<head>
    ...
    <link rel="preload" href="{{ asset('/css/bootstrap.min.css?v=5.92') }}" as="style">
    <link rel="preload" href="{{ asset('/css/style-date.css?v=5.92') }}" as="style">

    <!-- Load critical CSS -->
    <link href="{{ asset('/css/bootstrap.min.css?v=5.92') }}" rel="stylesheet">
    <link href="{{ asset('/css/style-date.css?v=5.92') }}" rel="stylesheet">

    <!-- Defer non-critical CSS -->
    <link rel="preload" href="{{ asset('/css/bootstrap-icons.min.css?v=5.92') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="{{ asset('/css/bootstrap-icons.min.css?v=5.92') }}">
    </noscript>
    <link rel="preload" href="{{ asset('/css/repont.css?v=5.92') }}" as="style"
        onload="this.onload=null;this.rel='stylesheet'">
    <noscript>
        <link rel="stylesheet" href="{{ asset('/css/repont.css?v=5.92') }}">
    </noscript>
...
<body>
    ...
    @if (request()->routeIs('home'))
        ...
        <script src="{{ asset('/js/simple-chart.js?v=5.92') }}" defer></script>
    @endif
